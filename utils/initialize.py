...
class Initialize:
    def __init__(self, username):
        self.social_media_list = ["github", "roblox", "facebook", "linkedin", "replit", "paypal", "youtube", "twitch", "tiktok", "instagram", "pornhub", "onlyfans", "twitter", "steam", "reddit", "feds", "discord", "ogu"]
